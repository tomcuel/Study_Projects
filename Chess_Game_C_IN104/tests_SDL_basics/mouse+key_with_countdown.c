...
int main(int argc, char* args[]) {
    ...
    // Countdown
    int seconds_remaining = 5;
    // Used to keep track of the last time we updated the countdown, just for the printing
    int last_second = 0;
    ...
    while (is_running){
        ...
        if (seconds_remaining > 0) {
            ...
            // Update the countdown every second to get the printing of the countdown
