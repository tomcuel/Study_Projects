...
void Change_Move_Log_Element(Move_Log_Element* elem, int previous_row, int previous_col, int destination_row, int destination_col, int check_state, int taken_piece_type, int taken_piece_color, int rock_type, int en_passant_type, int color_of_pawn_promoted, int type_of_pawn_promoted){
