...
void Change_Move_Log_Element(Move_Log_Element* elem, int previous_row, int previous_col, int destination_row, int destination_col, int check_state, int taken_piece_type, int taken_piece_color, int rock_type, int en_passant_type){
...
Move_Log_array_MESSAGE_TYPE Add_Element_in_Move_Log_array_at_Index(Move_Log_array* Moves_Log, Move_Log_Element* elem, int index){
	...
	Change_Move_Log_Element(Moves_Log->Move_Log[index], elem->move->previous_row, elem->move->previous_col, elem->move->destination_row, elem->move->destination_col, elem->check_state, elem->taken_piece_type, elem->taken_piece_color, elem->rock_type, elem->en_passant_type_done);
	}
