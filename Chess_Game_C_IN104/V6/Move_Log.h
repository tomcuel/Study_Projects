...
typedef struct {
	...
	int en_passant_type_done; // the type of the en passant move done : NO_EN_PASSANT or EN_PASSANT_DONE
	int color_of_pawn_promoted; // the color of the pawn promoted : WHITE or BLACK or NO_COLOR if no promotion
	int type_of_pawn_promoted; // the type of the pawn promoted : QUEEN, ROOK, BISHOP, KNIGHT or NOTHING if no promotion
	bool pawn_move_made; // the state of the pawn : true if it has moved, false otherwise used for the rules of 50 moves to the draw 
} Move_Log_Element;
 ...
 * @param en_passant_type_done - the type of the en passant move done : NO_EN_PASSANT or EN_PASSANT_DONE
 * @param color_of_pawn_promoted - the color of the pawn promoted : WHITE or BLACK or NO_COLOR if no promotion
 * @param type_of_pawn_promoted - the type of the pawn promoted : QUEEN, ROOK, BISHOP, KNIGHT or NOTHING if no promotion
 * @param pawn_move_made - the state of the pawn : true if it has moved, false otherwise used for the rules of 50 moves to the draw
**/
/////////////////////////////////////////////////////////////////////////////////////
