 ...
 * 
 * DrawLetterA - draws the letter 'A' using rectangles within a specified rectangle
 * DrawLetterB - draws the letter 'B' using rectangles within a specified rectangle
 * DrawLetterC - draws the letter 'C' using rectangles within a specified rectangle
 * DrawLetterD - draws the letter 'D' using rectangles within a specified rectangle
 * DrawLetterE - draws the letter 'E' using rectangles within a specified rectangle
 * DrawLetterF - draws the letter 'F' using rectangles within a specified rectangle
 * DrawLetterG - draws the letter 'G' using rectangles within a specified rectangle
 * DrawLetterH - draws the letter 'H' using rectangles within a specified rectangle
 * 
 * DrawNumber1 - draws the number '1' using rectangles within a specified rectangle
 * DrawNumber2 - draws the number '2' using rectangles within a specified rectangle
 * DrawNumber3 - draws the number '3' using rectangles within a specified rectangle
 * DrawNumber4 - draws the number '4' using rectangles within a specified rectangle
 * DrawNumber5 - draws the number '5' using rectangles within a specified rectangle
 * DrawNumber6 - draws the number '6' using rectangles within a specified rectangle
 * DrawNumber7 - draws the number '7' using rectangles within a specified rectangle
 * DrawNumber8 - draws the number '8' using rectangles within a specified rectangle
 * 
 * Will be use in the chessboard rendering, to show the row (number) and the column (letter) of the pieces
 * since it's displayed like that on the chessboard, without TTF since we didn't sucess to download it
**/
/////////////////////////////////////////////////////////////////////////////////////
