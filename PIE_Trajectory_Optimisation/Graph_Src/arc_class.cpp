...
bool are_segments_equal(const Segment& seg1, const Segment& seg2)
{
    return (seg1.points[0] == seg2.points[0] && seg1.points[1] == seg2.points[1]) || (seg1.points[0] == seg2.points[1] && seg1.points[1] == seg2.points[0]);
}
