...
file_path_inside = "inside_track_1.txt"
...
file_path_outside = "outside_track_1.txt"
...
file_path_centerline = "track_data_centered_test_1.csv"
...
plt.savefig("inside_outside_layout_1.png")
