...
int main ()
{
    ...
    double distance_from_track_center = 3.0;
    ...
    std::map<int, std::vector<double>> track_data = get_track_data("track_data_centered_test_2.csv");
    ...
    std::ofstream inside_track_file("inside_track_2.txt");
    std::ofstream outside_track_file("outside_track_2.txt");
    ...
    graph.exporte("graph_2.txt");
    graph.find_shortest_path_and_exporte("path_2.txt");

    system("python3 test_2_results.py");
