...
int main() 
{
    ...
    cout<<"\nAdjacency matrix for first graph : "<<endl;
    ...
    Point start2(-1, 0.5);
    Point goal2(2, -0.5);
    Graph graph2(obstacles2, start2, goal2, false);
    // Export the graph
    ...
    Point start3(-1, 0.5);
    Point goal3(4, -0.5);
    Graph graph3(obstacles3, start3, goal3, false);
    // Export the graph
    ...
    Point start4(-1, 0.5);
    Point goal4(2, -0.5);
    Graph graph4(obstacles4, start4, goal4, false);
    // Export the graph
    ...
    // lauching the python script to plot the results
