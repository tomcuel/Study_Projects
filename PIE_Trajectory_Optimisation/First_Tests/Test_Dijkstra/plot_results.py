...
points_1, segments_1, shortest_path_segments_1, obstacles_1 = get_data_from_file('graph.txt', 'shortest_path.txt')
plot_graph(points_1, segments_1, shortest_path_segments_1, obstacles_1, 'graph.png')
print('Graph 1 created')
points_2, segments_2, shortest_path_segments_2, obstacles_2 = get_data_from_file('graph2.txt', 'shortest_path2.txt')
print('Graph 2 created')
plot_graph(points_2, segments_2, shortest_path_segments_2, obstacles_2, 'graph2.png')
points_3, segments_3, shortest_path_segments_3, obstacles_3 = get_data_from_file('graph3.txt', 'shortest_path3.txt')
plot_graph(points_3, segments_3, shortest_path_segments_3, obstacles_3, 'graph3.png')
print('Graph 3 created')
points_4, segments_4, shortest_path_segments_4, obstacles_4 = get_data_from_file('graph4.txt', 'shortest_path4.txt')
plot_graph(points_4, segments_4, shortest_path_segments_4, obstacles_4, 'graph4.png')
