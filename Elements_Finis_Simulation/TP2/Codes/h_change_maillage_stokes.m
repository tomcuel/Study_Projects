function h_change_maillage_stokes(new_h_value)
% Lire le fichier .geo
filename = 'geomRectangle_partie3.geo';
...
system('/opt/homebrew/bin/gmsh geomRectangle_partie3.geo -2 -order 2 -o geomRectangle_partie3.msh');
end
